            ...
            <div class="space-y-10 lg:pl-16 xl:pl-24">
                <form class="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
                    <h2 class="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
                        <x-phosphor-envelope class="h-6 w-6 flex-none" />
                        <span class="ml-3">{{ __('Stay up to date') }}</span>
                    </h2>
                    <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                        {{ __('Get notified when I publish something new, and unsubscribe at any time.') }}
                    </p>
                    <div class="mt-6 flex">
                        <input
                            type="email"
                        ...
                        />
                        <x-button type="submit" class="ml-4 flex-none">{{ __('Join') }}</x-button>
                    </div>
                </form>
